...
/*define error code*/
#ifndef errno_t
typedef int errno_t;//lint !e1784 !e761
#endif
...
extern "C"
{
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    errno_t wmemcpy_s(wchar_t* dest, size_t destMax, const wchar_t* src, size_t count);//lint !e762
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    errno_t memmove_s(void* dest, size_t destMax, const void* src, size_t count);//lint !e762
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    errno_t wmemmove_s(wchar_t* dest, size_t destMax, const wchar_t* src, size_t count);//lint !e762
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    errno_t wcscpy_s(wchar_t* strDest, size_t destMax, const wchar_t* strSrc);//lint !e762
    ...
    * @return  EOK if there was no runtime-constraint violation
    */
    errno_t wcsncpy_s(wchar_t* strDest, size_t destMax, const wchar_t* strSrc, size_t count);//lint !e762
